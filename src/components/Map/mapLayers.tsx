...
export const baciasFills: LayerSpecification = {
  ...
  export const unclusteredPoint: LayerSpecification =  {
    ...
    layout: {
      "icon-image": ["get", "stType"], // reference the image and type station in geojson
      "icon-size": 0.25,
      visibility: "visible",
    },
  }
  ...
  export const addSubBasins = (map: maplibregl.Map, toggleSpinner: () => void, stopSpinner: (e: any) => void) => {
    toggleSpinner();
  ...
  export const addMajorBasins = (map: maplibregl.Map, toggleSpinner: () => void, stopSpinner: (e: any) => void) => {
    toggleSpinner();
  ...
  export const addRivers = (map: maplibregl.Map, toggleSpinner: () => void, stopSpinner: (e: any) => void) => {
    toggleSpinner();
  ...
  export const toggleMapLayers = (
    ...
    if (!added && layerId === "rivers") {
      ...
      if (layer.layerId === "bacias2" || layer.layerId === "bacias") {
        const basinVisibility = map.getLayoutProperty(
          layer.layerId+"-fills",
          "visibility"
        );
